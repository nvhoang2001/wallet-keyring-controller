...
var _KeyringController_instances,
	_KeyringController_keyring,
	_KeyringController_qrKeyringStateListener,
	_KeyringController_registerMessageHandlers,
	_KeyringController_addQRKeyring,
	_KeyringController_subscribeToQRKeyringEvents,
	_KeyringController_unsubscribeFromQRKeyringsEvents,
	_KeyringController_fullUpdate,
	_KeyringController_handleLock,
	_KeyringController_handleUnlock,
...
function assertHasUint8ArrayMnemonic(keyring) {
	if (
		!((0, utils_1.hasProperty)(keyring, "mnemonic") && keyring.mnemonic instanceof Uint8Array)
	) {
...
class KeyringController extends base_controller_1.BaseControllerV2 {
	...
	constructor({
		...
		__classPrivateFieldSet(
			this,
			_KeyringController_keyring,
			new eth_keyring_controller_1.KeyringController({
				initState: state,
				encryptor,
				keyringBuilders,
				cacheEncryptionKey,
		...
		__classPrivateFieldGet(this, _KeyringController_keyring, "f").memStore.subscribe(
			__classPrivateFieldGet(
				this,
				_KeyringController_instances,
				"m",
				_KeyringController_fullUpdate,
			).bind(this),
		);
		__classPrivateFieldGet(this, _KeyringController_keyring, "f").store.subscribe(
			__classPrivateFieldGet(
				this,
				_KeyringController_instances,
				"m",
		...
		__classPrivateFieldGet(this, _KeyringController_keyring, "f").on(
			"lock",
			__classPrivateFieldGet(
				this,
				_KeyringController_instances,
	...
	addNewAccount(accountCount) {
		return __awaiter(this, void 0, void 0, function* () {
			const primaryKeyring = __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getKeyringsByType("HD Key Tree")[0];
			/* istanbul ignore if */
			if (!primaryKeyring) {
				throw new Error("No HD keyring found");
			}
			const oldAccounts = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getAccounts();
			if (accountCount && oldAccounts.length !== accountCount) {
				...
				return {
					keyringState: __classPrivateFieldGet(
						this,
						_KeyringController_instances,
						"m",
						_KeyringController_getMemState,
			...
			yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").addNewAccount(
				primaryKeyring,
			);
			const newAccounts = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getAccounts();
	...
	addNewAccountForKeyring(keyring, accountCount) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const addedAccountAddress = (yield this.getAccounts()).find(
				(selectedAddress) => !oldAccounts.includes(selectedAddress),
			);
			(0, utils_1.assertIsStrictHexString)(addedAccountAddress);
	...
	addNewKeyring(type, opts) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			return __classPrivateFieldGet(this, _KeyringController_keyring, "f").addNewKeyring(
				type,
				opts,
			);
		});
	...
	verifyPassword(password) {
		return __awaiter(this, void 0, void 0, function* () {
			yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").verifyPassword(
				password,
			);
		});
	}
	...
	exportSeedPhrase(password) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			assertHasUint8ArrayMnemonic(
				__classPrivateFieldGet(this, _KeyringController_keyring, "f").keyrings[0],
			);
			return __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
	...
	exportAccount(password, address) {
		return __awaiter(this, void 0, void 0, function* () {
			yield this.verifyPassword(password);
			return __classPrivateFieldGet(this, _KeyringController_keyring, "f").exportAccount(
				address,
			);
		});
	}
	...
	decryptMessage(messageParams) {
		return __awaiter(this, void 0, void 0, function* () {
			return __classPrivateFieldGet(this, _KeyringController_keyring, "f").decryptMessage(
				messageParams,
			);
		});
	}
	...
	getKeyringsByType(type) {
		return __classPrivateFieldGet(this, _KeyringController_keyring, "f").getKeyringsByType(
			type,
		);
	}
	/**
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			switch (strategy) {
				case "privateKey":
					...
					/* istanbul ignore if */
					if (
						!(0, ethereumjs_util_1.isValidPrivate)(bufferedPrivateKey) ||
				...
				case "json":
					...
					try {
						...
						wallet =
							wallet ||
							(yield ethereumjs_wallet_1.default.fromV3(input, password, true));
					}
			...
			const newKeyring = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).addNewKeyring(KeyringTypes.simple, [privateKey]);
			const accounts = yield newKeyring.getAccounts();
			const allAccounts = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getAccounts();
	...
	removeAccount(address) {
		return __awaiter(this, void 0, void 0, function* () {
			yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").removeAccount(
				address,
			);
	...
	signMessage(messageParams) {
		...
		return __classPrivateFieldGet(this, _KeyringController_keyring, "f").signMessage(
			messageParams,
		);
	}
	/**
	...
	signPersonalMessage(messageParams) {
		return __classPrivateFieldGet(this, _KeyringController_keyring, "f").signPersonalMessage(
			messageParams,
		);
	}
	/**
	...
	signTransaction(transaction, from, opts) {
		return __classPrivateFieldGet(this, _KeyringController_keyring, "f").signTransaction(
			transaction,
			from,
			opts,
		);
	...
	submitEncryptionKey(encryptionKey, encryptionSalt) {
		return __awaiter(this, void 0, void 0, function* () {
			yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").submitEncryptionKey(
				encryptionKey,
				encryptionSalt,
			);
	...
	submitPassword(password) {
		return __awaiter(this, void 0, void 0, function* () {
			yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").submitPassword(
				password,
			);
			const accounts = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getAccounts();
	...
	verifySeedPhrase() {
		return __awaiter(this, void 0, void 0, function* () {
			const primaryKeyring = __classPrivateFieldGet(
				...
				_KeyringController_keyring,
				"f",
			).getKeyringsByType(KeyringTypes.hd)[0];
			/* istanbul ignore if */
			if (!primaryKeyring) {
				throw new Error("No HD keyring found.");
			}
			...
			const hdKeyringBuilder = __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getKeyringBuilderForType(KeyringTypes.hd);
	...
	getAccountKeyringType(account) {
		return __awaiter(this, void 0, void 0, function* () {
			return (yield __classPrivateFieldGet(
				...
				_KeyringController_keyring,
				"f",
			).getKeyringForAccount(account)).type;
		});
	}
	forgetQRDevice() {
		return __awaiter(this, void 0, void 0, function* () {
	...
	clear() {
		__classPrivateFieldGet(this, _KeyringController_keyring, "f").store.updateState({
			vault: "",
		});
	}
}
...
(_KeyringController_keyring = new WeakMap()),
	(_KeyringController_qrKeyringStateListener = new WeakMap()),
	(_KeyringController_instances = new WeakSet()),
	(_KeyringController_registerMessageHandlers =
		function _KeyringController_registerMessageHandlers() {
	...
	(_KeyringController_addQRKeyring = function _KeyringController_addQRKeyring() {
		return __awaiter(this, void 0, void 0, function* () {
			// QRKeyring is not yet compatible with Keyring type from @metamask/utils
			const qrKeyring = yield __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).addNewKeyring(KeyringTypes.qr);
			__classPrivateFieldGet(
				this,
				_KeyringController_instances,
				"m",
	...
	(_KeyringController_subscribeToQRKeyringEvents =
		function _KeyringController_subscribeToQRKeyringEvents(qrKeyring) {
			__classPrivateFieldSet(
				this,
				_KeyringController_qrKeyringStateListener,
				(state) => {
			...
			qrKeyring
				.getMemStore()
				.subscribe(
					__classPrivateFieldGet(this, _KeyringController_qrKeyringStateListener, "f"),
				);
		}),
	(_KeyringController_unsubscribeFromQRKeyringsEvents =
		function _KeyringController_unsubscribeFromQRKeyringsEvents() {
			const qrKeyrings = __classPrivateFieldGet(
				this,
				_KeyringController_keyring,
				"f",
			).getKeyringsByType(KeyringTypes.qr);
	...
	(_KeyringController_fullUpdate = function _KeyringController_fullUpdate() {
		const { vault } = __classPrivateFieldGet(
			this,
			_KeyringController_keyring,
			"f",
		).store.getState();
		const { keyrings, isUnlocked, encryptionKey, encryptionSalt } = __classPrivateFieldGet(
			this,
			_KeyringController_keyring,
			"f",
		).memStore.getState();
